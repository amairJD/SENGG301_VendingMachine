 ...
 * total value of the coins entered as payment. Note that some coins can be
 * "in limbo": entered in the machine but not yet used for a purchase; such
 * coins are not unloaded and cannot be checked. The two numbers are separated
 * by a semicolon. A sequence of comma-separated strings can follow these
 * numbers. If present, it is separated by a semicolon. Each string represents a
 * kind of pop that is expected to be found.
 * 
 * <p>
 * <b>Correct examples:</b>
 * 
